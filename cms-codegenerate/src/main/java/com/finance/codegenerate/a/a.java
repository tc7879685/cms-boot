...
package com.finance.codegenerate.a;
...
public class a {
    ...
    public static String c = "jdbc:mysql://localhost:3306/jeecg-boot?useUnicode=true&characterEncoding=UTF-8";
    public static String d = "root";
    public static String e = "root";
    public static String f = "jeecg-boot";
    public static String g = "c:/workspace/jeecg";
    public static String h = "com.jeecg";
    public static String i = "src";
    public static String j = "WebRoot";
    public static String k = "/jeecg/code-template/";
